...
fn format_tokens(tokens: &[RnsToken], source: &str) -> String {
    ...
    for token in tokens {
        let kind_str = match &token {
            ...
            RnsToken::DotInnerClassesAttr(_) => "DotInnerClassesAttr".to_string(),
            RnsToken::DotInnerClassesAttrEnd(_) => "DotInnerClassesAttrEnd".to_string(),
            RnsToken::DotInnerClass(_) => "DotInnerClass".to_string(),
            RnsToken::DotOuterClass(_) => "DotOuterClass".to_string(),
            RnsToken::DotFlags(_) => "DotFlags".to_string(),
            RnsToken::DotInnerName(_) => "DotInnerName".to_string(),
            ...
            RnsToken::AccessFlag(spanned) => format!("AccessFlag({})", spanned.value.token_name()),
            RnsToken::DotAnnotation(_) => "DotAnnotation".to_string(),
            RnsToken::TypeHint(spanned) => format!("TypeHint({})", spanned.value.token_name()),
        };
